...
Целевой бинарник должен понимать текущее состояние prepared statements.
Бинарники, которые читают число параметров Parse как знаковое 16-битное число,
не могут импортировать кешированные запросы с 32 768–65 535 явно заданными
типами параметров. Если такие запросы использовались, при откате на эти
бинарники нужно допустить переподключение затронутых клиентов. Миграция со
старого бинарника на версию с полным беззнаковым диапазоном сохраняет
существующий формат состояния.
